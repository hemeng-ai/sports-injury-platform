...
const QUICK_LOGINS = [
  ...
  { label: "游客登录", icon: User, role: "VISITOR", email: "visitor@sports-injury.local", password: "visitor123" },
];
      ...
      <div className="grid grid-cols-3 gap-2">
        {QUICK_LOGINS.map((ql) => {
          ...
          return (
            <Button
              key={ql.role}
              variant={ql.role === "SUPERADMIN" ? "default" : ql.role === "ADMIN" ? "secondary" : "outline"}
